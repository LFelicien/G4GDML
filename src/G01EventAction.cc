...
// ********************************************************************
//
// $Id: G01EventAction.cc 93886 2015-11-03 08:28:26Z gcosmo $
//
...
G01EventAction::G01EventAction(G01RunAction* runAction)
: G4UserEventAction(),
...
void G01EventAction::BeginOfEventAction(const G4Event*)
{    
  fEdep = 0.;
}
