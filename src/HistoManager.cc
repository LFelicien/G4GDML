...
void HistoManager::Book()
{
  ...
  id = analysis->CreateH1("h1.5","Energy deposition", nbins, vmin, vmax);
  analysis->SetH1Activation(id, false);
  id = analysis->CreateH1("h1.6","Energy charge non nulle", nbins, vmin, vmax);
  analysis->SetH1Activation(id, false);
  id = analysis->CreateH1("h1.7","Energy charge nulle", nbins, vmin, vmax);
  analysis->SetH1Activation(id, false);
  ...
  id = analysis->CreateH2("h2.5","direction: phi-theta",
                                          nbins,vmin,vmax, nbins,vmin,vmax);
  analysis->SetH2Activation(id, false);
  id = analysis->CreateH2("h2.6","Tracking position yz",
                                          nbins,vmin,vmax, nbins,vmin,vmax);
  analysis->SetH2Activation(id, false);
  id = analysis->CreateH2("h2.6","Tracking position yz",
                                          nbins,vmin,vmax, nbins,vmin,vmax);
